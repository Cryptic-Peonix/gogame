...
public class Player {
    ...
    private final StringProperty scoreStringProperty = new SimpleStringProperty("");
    private final StringProperty prisonerCountStringProperty = new SimpleStringProperty("");
